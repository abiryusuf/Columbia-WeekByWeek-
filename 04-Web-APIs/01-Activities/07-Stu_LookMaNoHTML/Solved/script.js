...
favoriteEl.textContent = "Week_4:";
li1.textContent = "Activity_13";
li2.textContent = "Activity_15";
li3.textContent = "";
...
doc.textContent ="Week_4 was a little bit complicated.";

body.appendChild(doc);

doc.setAttribute("style", "color: salmon; background: #666666; text-align: center; paddign: 5px" );